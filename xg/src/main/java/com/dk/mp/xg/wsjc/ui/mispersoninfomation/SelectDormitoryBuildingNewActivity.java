    ...
    protected void initView() {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.putExtra("url",getUrl(sslid,mTime.getText().toString()));
                startActivity(in);
            }
        });
    }
...
//        apps/sswsdftj/ssl                           apps/zxzssgl/sslList
    ...
    public String getUrl(String sslId,String date){
        String mUrl = mContext.getString(R.string.rootUrl)+"apps/zsscx/kqycryxx?sslid="+sslId+"&date="+date;
        if(loginMsg != null){
