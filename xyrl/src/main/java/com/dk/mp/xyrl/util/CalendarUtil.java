...
import com.dk.mp.xyrl.entity.RcapMonth;
...
public class CalendarUtil {
	...
	public static List<RcapMonth> initCalender() {
		List<RcapMonth> list = new ArrayList<RcapMonth>();
		Date date = new Date();
		...
		String currentDate = sdf.format(date); //当期日期
		 ...
		 for(int i=-12;i<12 ;i++){
			 RcapMonth m = new RcapMonth();
			 m.setDay_c(day_c);
			 m.setMonth_c(month_c);
			 m.setYear_c(year_c);
			 m.setJumpMonth(i);
			 m.setJumpYear(0);
			 list.add(m);
