...
import com.dk.mp.cjcx.adapter.XueShengAdapter;
 ...
 */
public class XueShengListActivity extends MyActivity {
    private ErrorLayout mError;
    private RecyclerView mList;
    private List<ScoreInquiry> mData = new ArrayList<>();
    private XueShengAdapter mAdapter;
    ...
    protected void initView() {
        super.initView();
        xueqiId=getIntent().getStringExtra("xqid");
        setTitle(getIntent().getStringExtra("title"));
        mError = (ErrorLayout) findViewById(R.id.error_layout);
        mList = (RecyclerView) findViewById(R.id.mListView);
        mList.setHasFixedSize ( true );
        mList.setLayoutManager ( new LinearLayoutManager( mContext ) );
        mAdapter = new XueShengAdapter(mContext,mData,xueqiId);
    ...
    public void getData(){
        ...
        HttpUtil.getInstance().postJsonObjectRequest("apps/cjcx/listStudent?idClass=" + getIntent().getStringExtra("bjid"), null, new HttpListener<JSONObject>() {
            @Override
