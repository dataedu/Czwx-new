...
public class BanJIAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public BanJIAdapter(Context mContext, List mData,String xqid) {
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                        Intent intent = new Intent(mContext,XueShengListActivity.class);//跳转工资详情
                        ScoreInquiry si = mData.get(getLayoutPosition());
                        intent.putExtra("bjid",si.getId());
