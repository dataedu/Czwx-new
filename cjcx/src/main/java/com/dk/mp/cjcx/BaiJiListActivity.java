...
import com.dk.mp.cjcx.adapter.BanJIAdapter;
 ...
 */
public class BaiJiListActivity extends MyActivity {
    private ErrorLayout mError;
    private RecyclerView mList;
    private List<ScoreInquiry> mData = new ArrayList<>();
    private BanJIAdapter mAdapter;
    ...
    protected void initView() {
        ...
        mAdapter = new BanJIAdapter(mContext,mData,xueqiId);
    ...
    public void getData(){
        ...
        HttpUtil.getInstance().postJsonObjectRequest("apps/cjcx/listBj?xueqiId=" + getIntent().getStringExtra("xqid"), null, new HttpListener<JSONObject>() {
            @Override
