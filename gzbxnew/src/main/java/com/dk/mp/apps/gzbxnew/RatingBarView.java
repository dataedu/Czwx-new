...
//        starImageSize = ta.getDimension(R.styleable.RatingBarView_starImageSize, 20);
        starImageSize = DeviceUtil.dip2px(context, 25);
        starCount = ta.getInteger(R.styleable.RatingBarView_starCount, 5);
        
        paddingLeft = ta.getInteger(R.styleable.RatingBarView_paddingLeft, 10);
        paddingRight = ta.getInteger(R.styleable.RatingBarView_paddingRight, 10);
        paddingBottom = ta.getInteger(R.styleable.RatingBarView_paddingBottom, 10);
        paddingTop = ta.getInteger(R.styleable.RatingBarView_paddingTop, 10);
