        ...
        public MyView(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ActivityCompat.startActivity((JyxxListActivity) mContext,intent,options.toBundle());
                    ((JyxxListActivity) mContext).overridePendingTransition(R.anim.slide_up, R.anim.scale_down);
                }
            });
        }
    }
