...
//    }
    ...
    public void setNoWorkNet() {
        ...
        zwsj_icon.setImageResource(R.drawable.net_fail);
        zwsj_text.setText(getString(R.string.net_no));
    }
    /**
     * 数据失败提示
     * @param text 提示文字
    ...
    public void setErrorDate(String text) {
        ...
        TextView zwsj_text = (TextView) findViewById(R.id.zwsj_text);
        zwsj.setVisibility(View.VISIBLE);
        zwsj_icon.setImageResource(R.drawable.data_fail);
        if(text!=null){
    ...
    public void setNoDate(String text) {
        ...
        TextView zwsj_text = (TextView) findViewById(R.id.zwsj_text);
        zwsj.setVisibility(View.VISIBLE);
        zwsj_icon.setImageResource(R.drawable.nodata);
        if(text!=null){
            zwsj_text.setText(text);
        }else{
